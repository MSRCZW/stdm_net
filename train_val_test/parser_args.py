...
def parser_args(block):
    ...
    parser.add_argument('-config', default='./train_val_test/config/ntu/ntu120_dstanet.yaml',help='Path to the configuration file')
    parser.add_argument('-model', default='dstanet')
    parser.add_argument('-model_saved_name', default='',help='Name of the saved model' )
    ...
    parser.add_argument('-val_first', default=False, help='Option to validate before training.' )
    parser.add_argument('-data', default='ntu_skeleton', help='Dataset to be used for training.')
    parser.add_argument('-data_param', default={}, help='Parameters for the dataset.')

    # hyperparameters as follows:
    # train_val test train_test
    parser.add_argument('-mode', default='train_val', help='Mode for running the script. Options are: train_val, test, train_test')
